...
export default function Sso() {
  ...
  return (
    <section className="flex flex-1 h-[35rem]">
      ...
      <div className="bg-gray text-white w-full">
        <div className="container mx-auto p-auto">
          <div className="flex flex-col w-full p-12 ">
            {!session ? (
              <>
                <p className="text-3xl md:text-5xl my-4 leading-relaxed md:leading-snug self-center">
                  Welcome to Secret Hub <span className="lightning">⚡️</span>
                </p>

                <div className="flex flex-col self-center mt-[5rem]">
              ...
              <>
                <p className="text-3xl md:text-5xl my-4 leading-relaxed md:leading-snug self-center pt-[8rem]">
                  Welcome to Secret Hub <span className="lightning">⚡️</span>{" "}
